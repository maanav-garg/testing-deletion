...
#define MyAppName "DiagBox"
#define MyAppVersion "1.3.0"
#define MyApp2ndName "DiagBox"
#define MyAppPublisher "Vestel"
#define MyAppExeName "DiagBox.exe"
#define ReleaseDir "..\DiagBox\DiagBox\bin\x64\Release"
...
AppId={{c364f7d4-1cb8-11ee-be56-0242ac120002}
AppName={#MyAppName}
...
[Files]
Source: "{#ReleaseDir}\Confused\DiagBox.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#ReleaseDir}\DiagBox.exe.config"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\..\Doc\DiagBox-UserManual.pdf"; DestDir: "{app}"; Flags: ignoreversion
